    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-7 col-md-offset-2">
                <form name="daftar_baru_form" action="<?php echo base_url();?>admin/pendaftaran/simpan_pendaftaran" method="post">
                    <div class="form-group">
                        <label for="">Desa</label>
                        <input name="desa" class="form-control" type="text" autocomplete="off">
                    </div>
                    <div class="form-group">
...
<script>
     $(function() {
      $("form[name='daftar_baru_form']").validate({
        rules: {
            desa: "required",
          kecamatan: {
            required: true,
